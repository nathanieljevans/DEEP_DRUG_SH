...
```{r}
t <- netwx$Weight %>% quantile(c(0.997))
t
...
mapped_netx %>% write_delim('./../data/genemania/GeneMania_AttentionWalk_input_all.csv', delim=',')
